...
namespace TinyZoo.Z_Quests.Advice
{
  internal class NarrativeInfoManager
  {
      ...
      bool IsForcedPopUpFromNewTask = false)
    {
      ...
      float width_ = Math.Max(uiScaleHelper.ScaleX(350f), vector2_1.X);
      ...
      this.headerparagraph = new SimpleTextHandler(TextToWrite1, width_, _CentreJustify, this.BaseScale, true, true);
      this.paragraph = new SimpleTextHandler(TextToWrite2, width_, _CentreJustify, this.BaseScale, AutoComplete: true);
