...
namespace TinyZoo.Tile_Data
{
  internal class TileData
  {
    ...
    {
      // ISSUE: The method is too long to display (97664 instructions)
    }
    ...
    internal static TileStats GetTileStats(TILETYPE getthis)
    {
      if (TileData.tilestats == null)
        TileData.tilestats = new TileStats[728];
      ...
      out ENRICHMENTBEHAVIOUR enrchmentbehaviour)
    {
      ...
      switch (EnrichmentData.GetTILETYPEToEnrichmentClass(tiletype))
      {
        ...
        case ENRICHMENTCLASS.BoneToy:
          flag = true;
          enrchmentbehaviour = ENRICHMENTBEHAVIOUR.ChewToy;
          break;
    ...
    internal static bool ThisStructureIsBlocking(TILETYPE tiletype) => tiletype != TILETYPE.None && tiletype != TILETYPE.FloorLight && tiletype != TILETYPE.TestFence;
    ...
    internal static bool IsThisATopFloorOnly(TILETYPE tiltype)
    {
      if (TileData.TopFloors == null)
      {
        ...
        TileData.TopFloors.Add(TILETYPE.Volume_WoodenBoards);
