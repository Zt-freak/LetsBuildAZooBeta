  ...
  internal class NotificationData
  {
      ...
      bool everythingsok)
    {
      switch (notification.notificationtype)
      {
        ...
        case Z_NotificationType.A_AddAnimalsToYourPen:
          return everythingsok ? "Your pens all have animals in them." : "There is a pen without animals. Add some animals to fill it up!";
        case Z_NotificationType.A_NoWater:
        ...
        case Z_NotificationType.TicketPrice:
          return notification.MoneyCost == ZTipType.TicketPriceTooExpensive ? "Your ticket price is too high! To change it click on the ticket office." : "Your ticket price is too low! To change it click on the ticket office.";
        case Z_NotificationType.E_VetHasNoRoute:
