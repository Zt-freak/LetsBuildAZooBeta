...
namespace TinyZoo.Z_Notification
{
  internal class Z_NotificationManager
  {
    ...
    internal static void TryAndSaySomething(int PenUID = -1, WalkingPerson walkingperson = null)
    {
    ...
    private void DeEmptyPenNotificationCheck(List<int> EmptyPensUID, Player player)
    {
      ...
      if (EmptyPensUID.Count > 0)
      {
        ...
        if (EmptyPensUID.Count > 5)
          notpackage.AlertStatus = NotificationAlertStatus.Danger;
      }
      else
      {
    ...
    private void DoAnimals(Player player)
    {
      ...
      {
        if ((double) player.prisonlayout.cellblockcontainer.prisonzones[index1].TempTotalWater <= 0.0)
        {
          ++num1;
          if (player.prisonlayout.cellblockcontainer.prisonzones[index1].prisonercontainer.prisoners.Count > 0)
            ++num2;
        }
        ...
        {
          if ((double) player.prisonlayout.cellblockcontainer.prisonzones[index1].prisonercontainer.tempAnimalInfo[index2].EnrichmentFullfillment < 1.0)
          {
            num4 += (1f - player.prisonlayout.cellblockcontainer.prisonzones[index1].prisonercontainer.tempAnimalInfo[index2].EnrichmentFullfillment) * (float) player.prisonlayout.cellblockcontainer.prisonzones[index1].prisonercontainer.tempAnimalInfo[index2].AllOfThese.Count;
            num3 += player.prisonlayout.cellblockcontainer.prisonzones[index1].prisonercontainer.tempAnimalInfo[index2].AllOfThese.Count;
          }
        }
        for (int index2 = 0; index2 < player.prisonlayout.cellblockcontainer.prisonzones[index1].prisonercontainer.prisoners.Count; ++index2)
        {
          if (player.prisonlayout.cellblockcontainer.prisonzones[index1].prisonercontainer.prisoners[index2]._IsDead)
          {
            ...
            if (player.prisonlayout.cellblockcontainer.prisonzones[index1].prisonercontainer.prisoners[index2].DaysSinceDeath > num6)
              num6 = player.prisonlayout.cellblockcontainer.prisonzones[index1].prisonercontainer.prisoners[index2].DaysSinceDeath;
          ...
          else if (player.prisonlayout.cellblockcontainer.prisonzones[index1].prisonercontainer.prisoners[index2].DaysWithoutFood > 2 && !Z_NotificationManager.AnimalsFFedToday.Contains(player.prisonlayout.cellblockcontainer.prisonzones[index1].prisonercontainer.prisoners[index2].intakeperson.UID))
          {
            ...
            if (player.prisonlayout.cellblockcontainer.prisonzones[index1].prisonercontainer.prisoners[index2].DaysWithoutFood > num5)
              num5 = player.prisonlayout.cellblockcontainer.prisonzones[index1].prisonercontainer.prisoners[index2].DaysWithoutFood;
          }
        }
      }
      ...
      if (num2 > 0)
      {
        notificationPackage1.AlertStatus = NotificationAlertStatus.Danger;
        notificationPackage1.CustomerHasTalkedAboutThis = 2;
      }
      else if (num1 > 0)
      {
        notificationPackage1.CustomerHasTalkedAboutThis = 1;
        notificationPackage1.AlertStatus = NotificationAlertStatus.Exclamation;
      }
      else
      {
      ...
      int num7 = Z_NotificationManager.RescrubWater ? 1 : 0;
      Z_NotificationManager.ShortCutButts[0].RemoveThis(Z_NotificationType.A_NoEnrichment);
      NotificationPackage notificationPackage2 = new NotificationPackage(Z_NotificationType.A_NoEnrichment);
      notificationPackage2.TotalDuplicates = num3;
      if ((double) num4 > 10.0)
      {
        notificationPackage2.AlertStatus = NotificationAlertStatus.Danger;
      ...
      Z_NotificationManager.ShortCutButts[0].TryAndScrubAnimalDuplicates(notificationPackage2);
      ...
      Z_NotificationManager.ShortCutButts[0].RemoveThis(Z_NotificationType.A_AddAnimalsToYourPen);
      this.DeEmptyPenNotificationCheck(EmptyPensUID, player);
      NotificationPackage notificationPackage3 = new NotificationPackage(Z_NotificationType.A_AnimalHunger, -1, -1, -1);
      notificationPackage3.AlertStatus = NotificationAlertStatus.Tick;
      if (num5 > 0 && num5 < 4 && intList1.Count < 6)
      {
        notificationPackage3.AlertStatus = NotificationAlertStatus.Danger;
      ...
      notificationPackage3.ListOfImpactedAnimalsByUID = intList1;
      notificationPackage3.ListOfImpactedAnimalsByValue = intList2;
      ...
      if (notificationPackage3.CustomerHasTalkedAboutThis > 0)
      {
        ...
        notificationPackage3.reasonfornotification = ReasonForNotification.HungryAnimals_Logistics;
        if (!player.storerooms.HasBuiltStoreRoom)
          notificationPackage3.reasonfornotification = ReasonForNotification.HungryAnimals_NoStoreRoom;
        else if (player.employees.GetEmployeesOfThisType(EmployeeType.Keeper).Count == 0)
          notificationPackage3.reasonfornotification = ReasonForNotification.HungryAnimals_NoZooKeeper;
        else if (player.storerooms.HasRunOutOfSomethingThatIsNeededByAnimals)
          notificationPackage3.reasonfornotification = ReasonForNotification.HungryAnimals_NoFood;
      }
      ...
      NotificationPackage notificationPackage4 = new NotificationPackage(Z_NotificationType.A_AnimalDeath);
      notificationPackage4.TotalDuplicates = intList3.Count;
      if (intList3.Count > 3 || num6 > 3)
      {
        notificationPackage4.AlertStatus = NotificationAlertStatus.Danger;
      ...
      else if (intList3.Count > 0)
      {
        ...
        notificationPackage4.AlertStatus = NotificationAlertStatus.Exclamation;
      }
      else
      {
      ...
      notificationPackage4.ListOfImpactedAnimalsByUID = intList3;
      ...
      if (!Z_NotificationManager.RescrubDeath || notificationPackage4.AlertStatus == NotificationAlertStatus.Tick)
      ...
      if (notificationPackage4.CustomerHasTalkedAboutThis <= 0)
        return;
      if (Z_NotificationManager.RescrubDeath && notificationPackage4.AlertStatus != NotificationAlertStatus.Tick)
        Z_NotificationManager.AddNotificationPackage(notificationPackage4, player);
      else
    ...
    public void DoShops(Player player)
    {
      ...
      if (intList.Count > 0)
      {
        ...
        {
          AlertStatus = NotificationAlertStatus.Danger,
