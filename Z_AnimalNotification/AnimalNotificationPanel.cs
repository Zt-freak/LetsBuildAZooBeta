...
namespace TinyZoo.Z_AnimalNotification
{
  internal class AnimalNotificationPanel
  {
      ...
      List<AnimalRenderDescriptor> hybridAnimals = null)
    {
      ...
      this.infoBox = new AnimalNotificationInfoBox(this.notificationType, basescale, infolist, hybridAnimals: hybridAnimals);
      ...
      if (this.needFixBox)
      {
        ...
        if ((double) sizeFrameless.Y > (double) vector2.Y)
        {
          ...
          this.infoBox = new AnimalNotificationInfoBox(this.notificationType, basescale, infolist, sizeFrameless.Y);
          if (this.infoBox.ConstructionFailed)
            this.ConstructionFailed = true;
        }
