...
namespace TinyZoo
{
  internal class ZooPopUp
  {
    ...
    public ZooPopUp(BuildingManageButton actiontype, Player player)
    {
      switch (actiontype)
      {
        ...
        case BuildingManageButton.GetParkStaff:
          ...
          this.generalemplyeemanager = new GeneralEmployeeManager(player);
          break;
    ...
    {
      this.featureunlockmanager = new FeatureUnlockManager(FeatureUnlockDisplayType.MoralityUsed);
    ...
    private void ConstructManageEmployeeManager(
      ...
      TILETYPE tileType,
      Player player,
      EmployeeType employeetype = EmployeeType.Count)
    {
      this.manageEmployeeManager = new ManageEmployeeManager(builingLocation, tileType, player, employeetype);
    ...
    public bool UpdateZooPopUps(Player player, float DeltaTime)
    {
      ...
      switch (this.thisstate)
      {
        case POPUPSTATE.People:
          ...
          break;
        case POPUPSTATE.Notification:
          WillClearInput = this.genericnotificationpopup.CheckMouseOver(player);
          flag = this.genericnotificationpopup.UpdateGenericNotificationManager(player, DeltaTime);
          break;
        case POPUPSTATE.Animal:
        ...
        case POPUPSTATE.UITest:
          flag = this.UI_Test.UpdateNewThingPanel(player, DeltaTime);
          break;
        case POPUPSTATE.Ticket:
        ...
        case POPUPSTATE.GeneralEmployees:
          ...
          if (SwitchToManage)
          {
            this.ConstructManageEmployeeManager((Vector2Int) null, TILETYPE.Count, player, this.generalemplyeemanager.SwitchToDetailViewForThis);
    ...
    public void DrawZooPopUp()
    {
      ...
      switch (this.thisstate)
      {
        ...
        case POPUPSTATE.Zoning:
          ...
          break;
        case POPUPSTATE.UITest:
          this.UI_Test.DrawNewThingPanel(AssetContainer.pointspritebatchTop05);
          break;
        case POPUPSTATE.Ticket:
