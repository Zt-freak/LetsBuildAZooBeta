  ...
  internal class ShopStatus
  {
      ...
      int ForceThisShopUID = -1)
    {
      ...
      if (IsMove && TileData.IsAManagementOffice(thingYouBuilt))
        PointOffScreenManager.DoubleCheckPointAtThis(Location, thingYouBuilt);
      ...
      else
      {
        ...
        if (IsMove)
        {
          ...
          this.shopentries[this.shopentries.Count - 1].OnMoveThisShop(Location);
        }
        if (ForceThisShopUID > -1)
        {
          Shop_UID = ForceThisShopUID;
    ...
    public ShopEntry GetThisFacility(int UID)
    {
      for (int index = 0; index < this.FacilitiesWithEmployees.Count; ++index)
      {
    ...
    public ShopEntry GetThisFacility(Vector2Int Location)
    {
      for (int index = 0; index < this.FacilitiesWithEmployees.Count; ++index)
      {
    ...
    public ShopEntry GetThisArchitectsOffice(int UID)
    {
      for (int index = 0; index < this.ArchitectOffice.Count; ++index)
      {
    ...
    public ShopEntry GetThisArchitectsOffice(Vector2Int Location)
    {
      for (int index = 0; index < this.ArchitectOffice.Count; ++index)
      {
    ...
    public ShopEntry GetThisShop(int UID)
    {
      for (int index = 0; index < this.shopentries.Count; ++index)
      {
    ...
    public ShopEntry GetThisShop(Vector2Int Location, TILETYPE tiletype)
    {
      for (int index = 0; index < this.shopentries.Count; ++index)
      {
