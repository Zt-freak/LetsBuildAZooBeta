...
namespace TinyZoo.PlayerDir.HeroQuests
{
  internal class HeroQuestDescription
  {
    ...
    public int UID;
    public HeroQuestDescription UnlockThisQuestCriteria;
      ...
      out int Progressend)
    {
      ...
      switch (this.heroquesttype)
      {
        ...
        case HEROQUESTTYPE.ThingsBuilt:
          ...
          return this.OtherValue != 728 ? string.Format(SEngine.Localization.Localization.GetText(887), (object) this.MustHaveThisMany, (object) TileData.GetTileStats((TILETYPE) this.OtherValue).Name) : string.Format(SEngine.Localization.Localization.GetText(888), (object) this.MustHaveThisMany, (object) CategoryData.GetCategoryToname((CATEGORYTYPE) this.OtherValue));
        case HEROQUESTTYPE.OtherHeroCharacterprogress:
    ...
    {
      if (this.OtherValue == 728)
        return player.prisonlayout.layout.GetTotalOfThese((CATEGORYTYPE) this.OtherValue);
      return this.OtherValue == 192 ? player.prisonlayout.layout.GetTotalOfThese((TILETYPE) this.OtherValue) + player.prisonlayout.layout.GetTotalOfThese(TILETYPE.Storeroom_BrownWood) + player.prisonlayout.layout.GetTotalOfThese(TILETYPE.Storeroom_Victorian) + player.prisonlayout.layout.GetTotalOfThese(TILETYPE.Storeroom_Monkey) : player.prisonlayout.layout.GetTotalOfThese((TILETYPE) this.OtherValue);
    }
