...
namespace TinyZoo.PlayerDir.HeroQuests.QuestMaker
{
  internal class Q_Investor
  {
    internal static HeroQuestPack GetQuests()
    {
      ...
      questDescription4.UnlockThisQuestCriteria = questDescription3;
      ...
      questDescription5.UnlockThisQuestCriteria = questDescription6;
      ...
      if (Z_DebugFlags.IsBetaVersion)
      {
        ...
        questDescription7.UnlockThisQuestCriteria = questDescription8;
        ...
        questDescription9.UnlockThisQuestCriteria = questDescription10;
        ...
        questDescription11.UnlockThisQuestCriteria = questDescription12;
      ...
      else
      {
        ...
        questDescription13.UnlockThisQuestCriteria = questDescription14;
