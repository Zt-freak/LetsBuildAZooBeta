...
namespace TinyZoo.PlayerDir
{
  internal class InputMap
  {
    ...
    public void UpdateInputMap(GenericInput genericinput, SEngine.Player.Player player, float DeltaTime)
    {
      this.CheckSwitchControllerIndexSwap(player);
      PC_KeyState.SetUpKeyboardState();
      this.PressedThisFrame = new bool[31];
      this.ReleasedThisFrame = new bool[31];
