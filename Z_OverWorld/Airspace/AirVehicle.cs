      ...
      bool SnapToSideOfScreen = false)
    {
      switch (behaviourtype)
      {
        case AirVehicleBehaviourType.AnimalDelivery:
          return (AirVehicleBehaviour) new DeliveryAirBehaviour(this, this.anchorpositions[0], this.delivery, this.OrderUID, SnapToSideOfScreen, this.DeliveringToThiusPenUID);
