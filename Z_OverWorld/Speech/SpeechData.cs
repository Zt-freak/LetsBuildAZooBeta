...
namespace TinyZoo.Z_OverWorld.Speech
{
  ...
  {
    internal static string GetThisNotificationToSpeech(Z_NotificationType notificationtype)
    {
      switch (notificationtype)
      {
        ...
        case Z_NotificationType.TicketPrice:
          switch (Game1.Rnd.Next(0, 5))
          {
            ...
            case 1:
              return "This zoo is too much,~The ticket price is crazy.";
            case 2:
            ...
            case 4:
              return "If the price of tickets is insane.~And by that I mean too much.";
          }
          break;
      }
      return "No String";
