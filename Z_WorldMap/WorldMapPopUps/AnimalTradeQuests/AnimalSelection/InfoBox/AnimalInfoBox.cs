...
namespace TinyZoo.Z_WorldMap.WorldMapPopUps.AnimalTradeQuests.AnimalSelection.InfoBox
{
  internal class AnimalInfoBox
  {
    ...
    public AnimalInfoBox(float _BaseScale, Vector2 forcedSize)
    {
      ...
      this.nothingSelectedText = new SimpleTextHandler("Select an animal to view its information and trade.", true, (float) ((double) forcedSize.X / 1024.0 * 0.899999976158142), this.BaseScale, AutoComplete: true);
