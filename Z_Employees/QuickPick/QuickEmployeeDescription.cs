...
namespace TinyZoo.Z_Employees.QuickPick
{
  internal class QuickEmployeeDescription
  {
    ...
    public int AgencyPay_WeeksLeft;
    ...
    private EmployeeType employeeType = EmployeeType.Count;

    public QuickEmployeeDescription(TILETYPE buildingthis, int _ShopUID)
    {
    ...
    public float GetServingTimeAndServe()
    {
      ...
      float num = this.Ref_ShopStatsCollection.MaxServingTime - (this.Ref_ShopStatsCollection.MaxServingTime - this.Ref_ShopStatsCollection.MinServingTime) * this.StoreEmployeeStatValues[4];
    ...
    public QuickEmployeeDescription(Reader reader, int VersionNumberForLoad)
    {
      ...
      int num2 = (int) reader.ReadInt("e", ref this.AgencyPay_WeeksLeft);
      int _out = 0;
      int num3 = (int) reader.ReadInt("e", ref _out);
      this.StoreEmployeeStatValues = new float[5];
      for (int index = 0; index < _out; ++index)
      {
        int num4 = (int) reader.ReadFloat("e", ref this.StoreEmployeeStatValues[index]);
      }
      int num5 = (int) reader.ReadInt("e", ref this.Rank);
      int num6 = (int) reader.ReadInt("e", ref _out);
      this.thisemployee = (AnimalType) _out;
      int num7 = (int) reader.ReadInt("e", ref _out);
      this.WorksHere = (TILETYPE) _out;
      int num8 = (int) reader.ReadInt("e", ref this.NameIndex);
      int num9 = (int) reader.ReadBool("e", ref this.IsAGirl);
      this.NAME = PeopleNames.GetName(!this.IsAGirl, out this.NameIndex, this.thisemployee, this.NameIndex);
      int num10 = (int) reader.ReadFloat("e", ref this.XP);
      int num11 = (int) reader.ReadFloat("e", ref this.Frustration);
      int num12 = (int) reader.ReadFloat("e", ref this.Determination);
      int num13 = (int) reader.ReadInt("e", ref this.FrustrationDaysFromOverwork);
      int num14 = (int) reader.ReadInt("e", ref this.ShopUID);
      int num15 = (int) reader.ReadInt("e", ref _out);
      this.seniorityLevel = (Seniority) _out;
      int num16 = (int) reader.ReadInt("e", ref _out);
      this.employeehistory = new List<EmployeeHistory>();
      for (int index = 0; index < _out; ++index)
        this.employeehistory.Add(new EmployeeHistory(reader));
      if (VersionNumberForLoad > 27)
      {
        int num17 = (int) reader.ReadInt("e", ref this.Level);
      }
      else
        this.Level = 1;
      this.Ref_ShopStatsCollection = ShopData.GetShopInfo(this.WorksHere);
    ...
    public void SaveQuickEmployeeDescription(Writer writer)
    {
      ...
      writer.WriteInt("e", this.AgencyPay_WeeksLeft);
