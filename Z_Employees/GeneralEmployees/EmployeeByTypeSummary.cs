...
namespace TinyZoo.Z_Employees.GeneralEmployees
{
  internal class EmployeeByTypeSummary
  {
      ...
      float UnmultipliedWidth)
    {
      ...
      this.littlesummarybutton = new LittleSummaryButton_AndHeading(LittleSummaryButtonType.Locate, this.BaseScale);
      this.littlesummarybutton.SetCustomHeading("View");
      this.littlesummarybutton.Location.X = -this.animalinframe.Location.X;
