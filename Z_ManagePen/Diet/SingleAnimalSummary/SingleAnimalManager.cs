...
namespace TinyZoo.Z_ManagePen.Diet.SingleAnimalSummary
{
  internal class SingleAnimalManager
  {
      ...
      AnimalType animalhead = AnimalType.None)
    {
      ...
      this.Micro_anaimalSummary = new MiniAnimalSummary(this.customerframe.VSCale, SelectedEnclosure, this.animaltype, this.mainanimalfoodmanager.TotalAnimals - this.mainanimalfoodmanager.TotaBabies, this.mainanimalfoodmanager.TotaBabies, baseScaleForUi);
