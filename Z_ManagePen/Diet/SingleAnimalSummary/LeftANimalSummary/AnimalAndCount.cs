...
namespace TinyZoo.Z_ManagePen.Diet.SingleAnimalSummary.LeftANimalSummary
{
  internal class AnimalAndCount
  {
    ...
    public void DrawAnimalAndCount(Vector2 Offset)
    {
      ...
      TextFunctions.DrawTextWithDropShadow("OMNIVORE", RenderMath.GetPixelSizeBestMatch(1f), this.LeftLocation + Offset, this.StatusTExt.GetColour(), this.StatusTExt.fAlpha, AssetContainer.SpringFontX1AndHalf, AssetContainer.pointspritebatchTop05, false);
    }
  }
}
