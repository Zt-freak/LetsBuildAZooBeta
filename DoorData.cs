      ...
      if (tileInfo.doorinfo == null)
      {
        switch (tiletype)
        {
          case TILETYPE.Nursery:
            tileInfo.doorinfo = new DoorInfo(new Rectangle(1245, 3909, 13, 16), new Vector2(6f, 9f));
            break;
          ...
          case TILETYPE.DNABuilding:
            tileInfo.doorinfo = new DoorInfo(new Rectangle(1746, 1563, 14, 15), new Vector2(7f, 19f));
            break;
