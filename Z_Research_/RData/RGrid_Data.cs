    ...
    internal static List<REntry> GetResearchData()
    {
      if (RGrid_Data.ResearchEntries == null)
      {
        ...
        if (Z_DebugFlags.IsBetaVersion)
        {
          ...
          RGrid_Data.ResearchEntries.Add(new REntry(UnlockTYPE.TolietPackOne, new Rectangle(643, 756, 32, 32), "Facility Pack - Toliet", "PLACEHOLDER", 2, UpgradeCategory.GiftShops, new TILETYPE[1]
          {
        ...
        else
        {
          ...
          RGrid_Data.ResearchEntries.Add(new REntry(UnlockTYPE.FoodShop_KangarooPizzaShop, new Rectangle(261, 702, 32, 32), "Panda Burg", "Unlock 1 more shop to increase the number of people who can be inside a Food shop by 1", 1, UpgradeCategory.FoodShops, new TILETYPE[1]
          {
