...
// Type: TinyZoo.Z_WeekOver.V2.Cubes.Cubes.AllThPeoplePaid
...
{
  internal class AllThPeoplePaid : BaseCube
  {
    public AllThPeoplePaid(float _BaseScale, Player player)
    ...
    public override void DrawBaseCube(Vector2 Offset, SpriteBatch spritebatch)
    {
      ...
      double num = (double) this.lerperBaseCube.Value;
    }
  }
}
