...
// Type: TinyZoo.Z_WeekOver.V2.Cubes.Cubes.EndOfWeek.HappiestCustomerCube
...
{
  internal class HappiestCustomerCube : BaseCube
  {
    public HappiestCustomerCube(float _BaseScale, Player player)
