...
// Type: TinyZoo.Z_WeekOver.V2.Cubes.Cubes.EndOfWeek.NewAnimalsCube
...
{
  internal class NewAnimalsCube : BaseCube
  {
    public NewAnimalsCube(float _BaseScale, Player player)
      : base(_BaseScale, true, new Vector3(0.4f, 0.3f, 0.6f))
    {
    }
