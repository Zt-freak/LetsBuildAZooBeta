...
// Type: TinyZoo.Z_WeekOver.V2.Cubes.Cubes.EndOfWeek.MainReasonForLeaving
...
{
  internal class MainReasonForLeaving : BaseCube
  {
    public MainReasonForLeaving(float _BaseScale, Player player)
