...
// Type: TinyZoo.Z_WeekOver.V2.Cubes.Cubes.EndOfWeek.CustomersCube
...
{
  internal class CustomersCube : BaseCube
  {
    public CustomersCube(float _BaseScale, Player player)
