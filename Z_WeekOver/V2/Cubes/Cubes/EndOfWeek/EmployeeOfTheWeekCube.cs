...
// Type: TinyZoo.Z_WeekOver.V2.Cubes.Cubes.EndOfWeek.EmployeeOfTheWeekCube
...
{
  internal class EmployeeOfTheWeekCube : BaseCube
  {
    public EmployeeOfTheWeekCube(float _BaseScale, Player player)
