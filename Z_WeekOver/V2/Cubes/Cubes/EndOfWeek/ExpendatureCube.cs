...
// Type: TinyZoo.Z_WeekOver.V2.Cubes.Cubes.EndOfWeek.ExpendatureCube
...
{
  internal class ExpendatureCube : BaseCube
  {
    public ExpendatureCube(float _BaseScale, Player player)
