...
// Type: TinyZoo.Z_WeekOver.V2.Cubes.CubeComponents.ResearchProgress
...
{
  internal class ResearchProgress : BaseCube
  {
    public ResearchProgress(float _BaseScale, Player player)
