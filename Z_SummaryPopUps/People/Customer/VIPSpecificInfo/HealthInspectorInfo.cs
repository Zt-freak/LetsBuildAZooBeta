...
// Type: TinyZoo.Z_SummaryPopUps.People.Customer.VIPSpecificInfo.HealthInspectorInfo
...
{
  internal class HealthInspectorInfo : VIPInfo
  {
    ...
    public HealthInspectorInfo(WalkingPerson person, float BaseScale, float forceThisWidth = -1f)
    {
      ...
      for (int index = 0; index < this.totalpens; ++index)
