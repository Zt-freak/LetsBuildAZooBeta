...
// Type: TinyZoo.Z_SummaryPopUps.People.Customer.ClosePubsActionPopUp
...
{
  internal class ClosePubsActionPopUp : CustomerActionPopUp
  {
    ...
    public ClosePubsActionPopUp(WalkingPerson walkingPerson, float basescale_)
      : base(basescale_)
    {
      this.thisperson = walkingPerson;
      this.button = new TextButton(this.basescale, SEngine.Localization.Localization.GetText(935), 40f);
      this.toggle = new OnOffToggleWithLabels(this.basescale, SEngine.Localization.Localization.GetText(941), SEngine.Localization.Localization.GetText(942));
