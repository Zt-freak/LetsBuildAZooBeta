...
namespace TinyZoo.Z_SummaryPopUps.People.Customer.CustomerActions.ActionPopUps
{
  internal class SellAnimalActionPopUp : CustomerActionPopUp
  {
      ...
      : base(BaseScale)
    {
      ...
      this.SizeFrame();
      this.moralityIcon = new GoodEvilIcon(false, basescale_: this.basescale, addInfoIcon: true, useXtraBig: true);
    ...
    private void SetUpAnimalSelect(Player player, AnimalType animaltypeFilter = AnimalType.None)
    {
      ...
      this.animalSelectionManager = new AnimalSelectionManager(true, player, this.basescale, this.framescale, animaltypeFilter, 5, 4);
    }
