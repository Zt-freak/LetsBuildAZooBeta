    ...
    public static string GetBodyParagraphForNews(FeatureUnlockDisplayType type)
    {
      ...
      switch (type)
      {
        ...
        case FeatureUnlockDisplayType.LandExpansion:
          ...
          break;
        case FeatureUnlockDisplayType.CRIPSRUnlocked:
          str = "Many scientists have put their heads together and come up with ground-breaking technology that will achieve the impossible - transferring animal heads and bodies to splice them together.~~When interviewed, the staff and management were very secretive about the process, but they claim that it is nothing illegal.~~Some people are concerned about what this means for the future, as well as the ethical issues this may occur. For others, this a large step in the direction of science that will hopefully bring the zoo and humanity to greater heights.~~It is unknown when the zoo intends to build the full facility and start their venture into animal splicing.";
          break;
        case FeatureUnlockDisplayType.MoralityUsed:
    ...
    public static string GetCaptionForThisPicture(PictureType pictureType)
    {
      switch (pictureType)
      {
        case PictureType.DNABuilding:
          return "Draft plan of DNA Splicing building";
        case PictureType.ResearchHub:
          return "Draft plan of the research building";
        ...
        case PictureType.ResearchHubDrawings:
          return "Illustrated guide of blueprints";
