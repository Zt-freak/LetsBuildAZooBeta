  ...
  internal class OverWorldManager
  {
      ...
      SpringIAPManager springIAPmanager)
    {
      ...
      else
      {
        ...
        {
          LiveStats.UpdateInOverworld(DeltaTime, players[0], OverWorldManager.overworldenvironment.wallsandfloors, this);
          ...
          else
          {
            ...
            else
            {
              ...
              {
                if (Z_GameFlags.ForceToNewScreen != ForceToNewScreen.None && OverWorldManager.zoopopupHolder.IsNull())
                {
                ...
                if (OverWorldManager.overworldstate == OverWOrldState.MainMenu)
                {
                  OverWorldManager.selectedthingmanager.UpdateSelectedThingManager(players[0], DeltaTime, OverWorldManager.overworldenvironment);
                  if (OverWorldManager.overworldstate != OverWOrldState.MainMenu)
              ...
              if (OverWorldManager.overworldstate == OverWOrldState.FireEmployees && OverWorldManager.firingmanager.UpdateFiringManager(players[0], DeltaTime))
              {
                OverWorldManager.overworldstate = OverWOrldState.MainMenu;
                this.hudmanager.ReturnToMainMenu();
              }
