    ...
    internal static float SetUp(AnimalType animaltype)
    {
      ...
      if (AnimalData.AnimalStats == null)
      {
        ...
        for (int Row = 1; Row < csvFileReader.GetRowCount(); ++Row)
        {
          ...
          AnimalData.AnimalStats[stringToAnimal].Aggression = (float) Convert.ToInt32(csvFileReader.GetCell(Row, 6));
          AnimalData.AnimalStats[stringToAnimal].Strength = (float) Convert.ToInt32(csvFileReader.GetCell(Row, 7));
          AnimalData.AnimalStats[stringToAnimal].AttackSpeed = (float) Convert.ToInt32(csvFileReader.GetCell(Row, 8));
          AnimalData.AnimalStats[stringToAnimal].Defence = (float) Convert.ToInt32(csvFileReader.GetCell(Row, 9));
          string cell = csvFileReader.GetCell(Row, 10);
          if (!(cell == "H"))
          {
            if (!(cell == "C"))
            {
          ...
          AnimalData.AnimalStats[stringToAnimal].Compatibility_GrassLand = Convert.ToInt32(csvFileReader.GetCell(Row, 11));
          AnimalData.AnimalStats[stringToAnimal].Compatibility_Forest = Convert.ToInt32(csvFileReader.GetCell(Row, 12));
          AnimalData.AnimalStats[stringToAnimal].Compatibility_Desert = Convert.ToInt32(csvFileReader.GetCell(Row, 13));
          AnimalData.AnimalStats[stringToAnimal].Compatibility_Mountain = Convert.ToInt32(csvFileReader.GetCell(Row, 14));
          AnimalData.AnimalStats[stringToAnimal].Compatibility_Arctic = Convert.ToInt32(csvFileReader.GetCell(Row, 15));
          AnimalData.AnimalStats[stringToAnimal].Compatibility_Tropical = Convert.ToInt32(csvFileReader.GetCell(Row, 16));
          AnimalData.AnimalStats[stringToAnimal].Compatibility_Savannah = Convert.ToInt32(csvFileReader.GetCell(Row, 17));
        }
